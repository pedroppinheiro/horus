 ...
 *
 */
public abstract class GOLPage extends PageObject {
	...
	public GOLPage acessarPagina(String pagina) throws Exception {
		return acessarPagina(PaginasEnum.getDominioPaginasByNome(pagina));
	}

	public GOLPage acessarPagina(PaginasEnum pagina) throws Exception {
